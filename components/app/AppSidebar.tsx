...
import { Sparkle, Grid, Book, Mic, Chart, Wallet, Gift, Gear, Clock, Target, Logout } from "@/components/ui/icons";
  ...
  return (
    <aside className="sticky top-0 hidden h-screen w-[260px] flex-col bg-[#142b4c] px-4 py-6 md:flex">
      ...
      <nav className="mt-8 flex flex-col gap-1">
        ...
        {role === "ADMIN" && (
          <>
            <p className="px-3 pb-1 pt-5 text-[11px] font-semibold uppercase tracking-wider text-white/35">Staff</p>
            <NavLink href="/admin" label="Admin" Icon={Target} />
          </>
        )}
      </nav>
      ...
      <div className="mt-auto">
        <div className="rounded-2xl bg-white/5 p-4">
          <div className="flex items-center gap-2 text-sm font-semibold text-white">
            <Sparkle className="h-4 w-4 text-[#3ecb8a]" /> Meet Nina
          </div>
